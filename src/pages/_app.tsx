...
const theme = createTheme({
  ...
  colors: {
    ...
    taupe: ["#f6f5f4", "#e7e7e7", "#cdcdcd", "#b1b1b1", "#9b9b9b", "#8c8b8a", "#3F3935", "#75716e", "#696460", "#5e554f"],
    dun: ["#fff4e8", "#f5e7d8", "#e7cdb4", "#d8b28b", "#cd9a69", "#c58b53", "#c28446", "#ab7138", "#99652e", "#865624"],
    seasalt: ["#f3f3f6", "#e4e4e6", "#c7c7cc", "#a8a8b5", "#8d8da0", "#7c7c93", "#F7F7F9", "#62627b", "#57566f", "#4a4a63"],
    isabelline: ["#fcf4ed", "#eee7e0", "#daccc1", "#c6b19f", "#b59981", "#ab896e", "#a78263", "#926e52", "#836247", "#735339"]
  },
